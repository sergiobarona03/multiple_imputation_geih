...
poverty_1_outcome_ind$tasa = (sum(poverty_dieta_1_ind$dummy_ind)/N)*100
poverty_1_outcome_ind$brecha = sum(poverty_dieta_1_ind$brecha_rel)/N
poverty_1_outcome_ind$severidad = sum(poverty_dieta_1_ind$brecha_rel_sqr)/N


######################################
## Dieta nutricionalmente adecuada  ##
######################################
N = sum(poverty_dieta_2$P6008)
...
poverty_2_outcome_ind$tasa = (sum(poverty_dieta_2_ind$dummy_ind)/N)*100
poverty_2_outcome_ind$brecha = sum(poverty_dieta_2_ind$brecha_rel)/N
poverty_2_outcome_ind$severidad = sum(poverty_dieta_2_ind$brecha_rel_sqr)/N

######################################
## Dieta saludable o recomendada    ##
######################################

N = sum(poverty_dieta_3$P6008)
...
poverty_3_outcome_ind$tipo = "Dieta nutritiva"
poverty_3_outcome_ind$tasa = (sum(poverty_dieta_3_ind$dummy_ind)/N)*100
poverty_3_outcome_ind$brecha = sum(poverty_dieta_3_ind$brecha_rel)/N
poverty_3_outcome_ind$severidad = sum(poverty_dieta_3_ind$brecha_rel_sqr)/N
